...
cartella_lavoro = '/home/cfmi.arpal.org/daniele.carnevale/Scrivania/lavoro_mare/dati/CERRA_singoli'
os.chdir(cartella_lavoro)
cartella_plot = '/home/cfmi.arpal.org/daniele.carnevale/Scrivania/lavoro_mare/dati/CERRA_singoli/plot_CERRA'
...
for cartella in lista_cartelle_cicloni[0:1]:
    ...
    if len(lista_file_nc) == 0:
        print('{cartella}, lista_file_nc vuota. Continuo.')
        continue
    ...
    for f in lista_file_nc:
        ...
        for ind_t, t in enumerate(valid_time):
            ...
            # u10, v10 = wind_components(si10[ind_t, :, :] * units('m/s'), wdir10[ind_t, :, :] * units.deg)
            knu10_t, knv10_t = wind_components(nodi10[ind_t, :, :] * units('knots'), wdir10[ind_t, :, :] * units.deg)
            ws10_t = si10[ind_t, :, :]
