...
cartella_download = f'{cartella_lavoro}/NOAA2_annuali'
os.makedirs(cartella_download, exist_ok=True)

# %%
lista_anni = np.arange(1979, 2023)

### Da: https://www.psl.noaa.gov/data/gridded/data.ncep.reanalysis2.html
### 44 - Mean Sea Level Pressure - Individual Obs - Sea Level -	4x Daily

os.chdir(cartella_download)

for anno in lista_anni:
    print('Anno = {anno}')
    stringa_download = f'https://downloads.psl.noaa.gov//Datasets/ncep.reanalysis2/surface/mslp.{anno}.nc'
