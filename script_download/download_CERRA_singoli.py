...
cartella_download = f'{cartella_lavoro}/CERRA_singoli'
...
for int_tempi in lista_range_tempi:
    ...
    for t in range_tempo:
        ...
        target = f'{sub_cartella_download}/CERRA_{t.year}_{t.month:02d}_{t.day:02d}.nc'

        client = cdsapi.Client()

        if os.path.exists(f'{sub_cartella_download}/CERRA_{t.year}_{t.month:02d}_{t.day:02d}.nc'):
            print(f'{sub_cartella_download}/CERRA_{t.year}_{t.month:02d}_{t.day:02d}.nc esiste. Continuo.')
            ...
            try:
                ...
                print('\n\nERRORE: la data non è presente. Continuo.\n\n')
                os.system(f'rmdir {sub_cartella_download}')
                break
